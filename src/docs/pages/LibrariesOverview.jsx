...
const LIBS = [
  ...
  { slug: 'lib-rtc', name: 'Rtc', blurb: 'PCF8563 / DS3231 real-time clock over I²C.' },
  ...
  { slug: 'lib-memory', name: 'MemoryManager', blurb: 'On-demand RAM reclaim via priority-ordered cache sinks.' },
  ...
  { slug: 'lib-detect', name: 'XteinkDetect', blurb: 'Runtime X3/X4 and display-controller detection via bus fingerprinting.' },
  ...
  { slug: 'lib-book', name: 'FreeInkBook', blurb: 'A complete EPUB reading engine — layout, cache, fonts, i18n text.' },
]
