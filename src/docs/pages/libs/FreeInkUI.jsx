    ...
    .inputMask = freeink::ui::InputTouch |
      ...
      <Table
        ...
        rows={[
          ...
          [<Code key="d">list</Code>, 'Virtualized rows; fill/outline/pill styles plus Underline/Triangle selection markers; hug-content pill rows; section headers; an optional per-row subtitle beneath the label; vertically-centered row content; and dynamic per-row height so a wrapped multi-line label (maxLines > 1) grows its row instead of clipping.'],
