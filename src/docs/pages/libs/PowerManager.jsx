    ...
    <>
      ...
      <ApiTable
        rows={[
          ...
          ['deepSleep()', 'Isolate floating GPIOs, then enter deep sleep. Normally does not return (chip resets on wake); if the entry is aborted (a wake source already latched), it recovers and returns instead of spinning, so the caller can retry.'],
