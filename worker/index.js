// FreeInk docs Worker.
//
// Serves the built SPA from the ASSETS binding and adds one dynamic route,
// /api/search, that does semantic search over the docs: it embeds the query
// with Workers AI (the same bge-base-en-v1.5 model used to build the index) and
// looks up the nearest doc chunks in Vectorize. The index is populated out of
// band by scripts/index-docs.mjs.
